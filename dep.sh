...
# additional
paru -S hyprmon-bin hyprpolkitagent thunar thunar-archive-plugin docker docker-compose uv distrobox lazygit lazydocker lazyssh tumbler vorta tailscale gh-cli telegram-desktop spotify vesktop gvfs gnome-disk-utility wireguard-tools gnome-disk-utility thunar-vfs-davs file-roller lolcat cowsay
